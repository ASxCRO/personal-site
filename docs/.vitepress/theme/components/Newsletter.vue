...
<template>
  <div class="bg-[color:var(--color-bg-variant)] rounded-2xl p-8 text-center max-w-xl mx-auto">
    <h3 class="text-[color:var(--color-primary)] text-xl mb-2">Subscribe to my Newsletter</h3>
    <p class="text-[color:var(--color-light)] text-sm mb-6">
      Get the latest articles on .NET, software architecture, and development best practices delivered to your inbox.
    </p>
    ...
    <p v-if="status === 'success'" class="text-[color:var(--color-primary)] mt-4 text-sm">
