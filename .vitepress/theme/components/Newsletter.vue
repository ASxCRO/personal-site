...
const BUTTONDOWN_USERNAME = 'antoniosupan'
...
const subscribe = async () => {
  ...
  try {
    ...
    try {
      await fetch(`https://buttondown.email/api/emails/${BUTTONDOWN_USERNAME}`, {
        method: 'POST',
        body: formData,
  ...
  <div class="newsletter-wrapper">
    <div class="newsletter-card">
      ...
      <div class="newsletter-content">
        <div class="newsletter-header">
          ...
          <div class="header-text">
            ...
            <p class="newsletter-subtitle">
              Get notified about new articles on .NET, cloud architecture, and software engineering best practices.
            </p>
          </div>
        </div>
        ...
        >
          <div class="input-group" v-if="status !== 'success'">
            ...
            <button
              ...
              :disabled="status === 'loading'"
            >
              <span v-if="status === 'idle'" class="btn-text">Subscribe</span>
              <span v-else-if="status === 'loading'" class="btn-loading">
                <svg class="spinner" width="20" height="20" viewBox="0 0 24 24">
                  <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" fill="none" stroke-dasharray="32" stroke-linecap="round"/>
                </svg>
              </span>
              <span v-else class="btn-text">Try Again</span>
          ...
          <!-- Error state -->
          <p v-if="status === 'error' && errorMessage" class="error-message">
            {{ errorMessage }}
          </p>
        </form>

        <!-- Trust indicators -->
        <div class="trust-indicators" v-if="status !== 'success'">
